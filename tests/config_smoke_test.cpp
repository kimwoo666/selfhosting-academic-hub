...
int main() {
    ...
    const fs::path temp_dir = fs::temp_directory_path() / "academic_hub_config_smoke";
  ...
  "server": {
    ...
    set_env_var("ACADEMIC_HUB_CONFIG", "");
    ...
    set_env_var("ACADEMIC_HUB_CONFIG", explicit_config.string().c_str());
